...
import Model.Usuario.DatosAutentificacionUsuario;
...
import seguridad.DatosJWTToken;
...
public class AutenticationController {
        ...
        public ResponseEntity autenticarUsuario(@RequestBody @Valid DatosAutentificacionUsuario datosAutentificacionUsuario) {
            Authentication authToken = new UsernamePasswordAuthenticationToken(datosAutentificacionUsuario.nombre(),
